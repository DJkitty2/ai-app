this project is me trying to make my own Nuero-Sama hevealy inpired by vedal and his work.
...
the defalt model is gemma3:1b, and will use gemma3 if more then 10 gb of ram and this will work with some Chain-of-thought (CoT) deepseek r1
